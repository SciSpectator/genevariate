...
from genevariate.core import llm_client as _llm_client

# Constants
DEFAULT_MODEL = "gemma4:e2b"
# Ollama's own convention for OLLAMA_HOST is a bare host:port, which requests
# rejects with InvalidSchema. llm_client.ollama_url() adds the scheme.
DEFAULT_URL = _llm_client.ollama_url()
